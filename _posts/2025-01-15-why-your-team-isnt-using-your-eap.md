...
**You're not alone.** EAP utilisation rates typically hover between 4 and 10 percent across most organisations, with some studies showing rates as low as 1 to 2 percent.<sup>1</sup> That means the vast majority of employees who could access free mental health support simply *don't*.
...
The fear is widespread and not irrational. Research from the American Psychological Association found that **39 percent of workers** worry that disclosing a mental health condition to their employer would negatively impact them at work. Among workers who already feel psychologically unsafe, that number climbs to **57 percent**.<sup>3</sup>
...
Here's the problem: Research suggests that most people need **15 to 20 sessions** for symptoms to meaningfully improve.<sup>1</sup> Yet the average EAP delivers just **2.5 counselling sessions** per person.
...
1. Meditopia. (2025). EAP Statistics and Utilization Rates in 2025. [meditopia.com](https://meditopia.com/en/forwork/articles/eap-statistics-and-utilization-rates){:target="_blank" rel="noopener"}
2. Uprise Health. (2024). Five Strategies to Increase EAP Utilization. [uprisehealth.com](https://uprisehealth.com/resources/maximizing-the-impact-of-employee-assistance-programs/){:target="_blank" rel="noopener"}
3. American Psychological Association. (2024). 2024 Work in America Survey. [apa.org](https://www.apa.org/pubs/reports/work-in-america/2024){:target="_blank" rel="noopener"}
